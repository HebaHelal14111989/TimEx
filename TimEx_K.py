...
data = pd.read_csv('E:\\PHD\\Thesis\\Spring2024\\Dataset\\AU.csv')  #E:\\PHD\\Thesis\\UAE_US_Parks_ALL_DATASET.csv
data1 = pd.read_csv('E:\\PHD\\Thesis\\Spring2024\\Dataset\\AU.csv')
...
for p in L:
    plt.plot(K_dict[p], no_prune_savings_dict[p], label='Linear Search', marker = 'o', color = 'b')
    plt.plot(K_dict[p], Prune_point_dict[p], label='TimEx-pruning', marker = 'x', color = 'orange')
    #plt.plot(L_dict[p], Prune_savings_dict[p], label='Aggregate Horizontal pruning', marker = 'o')
    plt.plot(K_dict[p], share_pane_savings_dict[p], label='TimEx-sharing', marker = '.', color = 'g')
    plt.plot(K_dict[p], combine_prune_paned_savings_dict[p], label='TimEx-hybrid', marker = 'D', color = 'r')
    plt.xticks(ticks=K_dict[p], labels=K_dict[p], rotation=45)
...
for p in L:
    plt.plot(K_dict[p], no_prune_dict[p], label='Linear Search', marker = 'o', color = 'b')
    plt.plot(K_dict[p], Prune_point_actual_dict[p], label='TimEx-pruning', marker = 'x', color = 'orange')
    #plt.plot(L_dict[p], Prune_actual_dict[p], label='Aggregate Horizontal pruning', marker = 'o')
    plt.plot(K_dict[p], share_pane_dict[p], label='TimEx-sharing', marker = '.', color = 'g')
    plt.plot(K_dict[p], combine_prune_paned_actual_dict[p], label='TimEx-hybrid', marker = 'D', color = 'r')
    plt.xticks(ticks=K_dict[p], labels=K_dict[p], rotation=45)
...
for p in L:
    ...
    plt.plot(K_dict[p], per_prune_point_dict[p], label='TimEx-pruning', marker = 'x', color = 'orange')
    #plt.plot(L_dict[p], per_prune_savings_dict[p], label='Aggregate Horizontal pruning', marker = 'o')
    plt.plot(K_dict[p], per_share_pane_savings_dict[p], label='TimEx-sharing', marker = '.', color = 'g')
    plt.plot(K_dict[p], per_combine_prune_paned_savings_dict[p], label='TimEx-hybrid', marker = 'D', color = 'r')
    plt.xticks(ticks=K_dict[p], labels=K_dict[p], rotation=45)
...
for p in L:
    ...
    plt.plot(K_dict[p], per_prune_point_actual_dict[p], label='TimEx-pruning', marker = 'x', color = 'orange')
    #plt.plot(L_dict[p], per_prune_actual_dict[p], label='Aggregate Horizontal pruning', marker = 'o')
    plt.plot(K_dict[p], per_share_pane_dict[p], label='TimEx-sharing', marker = '.', color = 'g')
    plt.plot(K_dict[p], per_combine_prune_paned_actual_dict[p], label='TimEx-hybrid', marker = 'D', color = 'r')
    plt.xticks(ticks=K_dict[p], labels=K_dict[p], rotation=45)
