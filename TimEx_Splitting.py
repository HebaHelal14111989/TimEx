...
#For Global min-max normalization, we change lines 215, 216, 231, 232, 974, 975, 989, 990
#Horizontal Paned Pruning + Sharing + Integration  (_R)
N = [200]  #Time series data length
...
#print(data)
UAE_ACTUAL = data['workplaces'].iloc[400 : 601]   #UAE_parks  UAE_workplaces
US_ACTUAL = data['residential'].iloc[400 : 601]    #US_parks   UAE_residential
...
for sh in SHIFT:
    #for n in N:
        ...
        UAE_ACTUALL = data1['workplaces'].iloc[400 : 601]  #UAE_parks   UAE_workplaces
        US_ACTUALL = data1['residential'].iloc[400 : 601]  #US_parks    UAE_residential
        df = pd.concat([UAE_ACTUAL, US_ACTUAL])
        #min_1 = df.min()
        #max_1 = df.max()
        #print(min_1, max_1)
        ...
        for l in L:
            ...
            if((n-l)%sh==0 and (n-l)!=0):
                ...
                min_2 = UAE_ACTUALL.min()
                max_2 = UAE_ACTUALL.max()
                #print("min_2 ",min_2)
                #print("max_2 ",max_2)
                if (min_2 == max_2):
...
# #Plot Amount of savings
# for p in SHIFT:
#     #plt.plot(L_dict[p], no_prune_savings_dict[p], label='Linear Search', marker = 'o')
#     #plt.plot(L_dict[p], Prune_point_dict[p], label='TiMEx-pruning', marker = 'x')
#     #plt.plot(L_dict[p], Prune_savings_dict[p], label='Aggregate Horizontal pruning', marker = 'o')
#     #plt.plot(L_dict[p], share_pane_savings_dict[p], label='TiMEx-sharing', marker = '.')
#     plt.plot(L_dict[p], combine_prune_paned_savings_dict[p], label='TiVEx-hybrid', marker = 'D')
#     plt.xticks(ticks=L_dict[p], labels=L_dict[p], rotation=45)
...
# #Plot Amount of operations
# for p in SHIFT:
#     #plt.plot(L_dict[p], no_prune_dict[p], label='Linear Search', marker = 'o')
#     #plt.plot(L_dict[p], Prune_point_actual_dict[p], label='TiVEx-pruning', marker = 'x')
#     #plt.plot(L_dict[p], Prune_actual_dict[p], label='Aggregate Horizontal pruning', marker = 'o')
#     #plt.plot(L_dict[p], share_pane_dict[p], label='TiVEx-sharing', marker = '.')
#     plt.plot(L_dict[p], combine_prune_paned_actual_dict[p], label='TiVEx-hybrid', marker = 'D')
#     plt.xticks(ticks=L_dict[p], labels=L_dict[p], rotation=45)
...
# #Plot Percentage Amount of savings
# for p in SHIFT:
#     #plt.plot(L_dict[p], per_no_prune_savings_dict[p], label='Linear Search', marker = 'o')
#     #plt.plot(L_dict[p], per_prune_point_dict[p], label='TiVEx-pruning', marker = 'x')
#     #plt.plot(L_dict[p], per_prune_savings_dict[p], label='Aggregate Horizontal pruning', marker = 'o')
#     #plt.plot(L_dict[p], per_share_pane_savings_dict[p], label='TiVEx-sharing', marker = '.')
#     plt.plot(L_dict[p], per_combine_prune_paned_savings_dict[p], label='TiVEx-hybrid', marker = 'D')
#     plt.xticks(ticks=L_dict[p], labels=L_dict[p], rotation=45)
...
# #Plot Percentage Amount of operations
# for p in SHIFT:
#     #plt.plot(L_dict[p], per_no_prune_dict[p], label='Linear Search', marker = 'o')
#     #plt.plot(L_dict[p], per_prune_point_actual_dict[p], label='TiVEx-pruning', marker = 'x')
#     #plt.plot(L_dict[p], per_prune_actual_dict[p], label='Aggregate Horizontal pruning', marker = 'o')
#     #plt.plot(L_dict[p], per_share_pane_dict[p], label='TiVEx-sharing', marker = '.')
#     plt.plot(L_dict[p], per_combine_prune_paned_actual_dict[p], label='TiVEx-hybrid', marker = 'D')
#     plt.xticks(ticks=L_dict[p], labels=L_dict[p], rotation=45)
